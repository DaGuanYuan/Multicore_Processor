...
test_case_table_generic_with_delays = mk_test_case_table([
  (                         "msg_func               mem_data_func         nbank stall lat src sink"),
  [ "read_hit_1word_clean",  read_hit_1word_clean,  None,                 0,    0.5,  0,  0,  0    ],
  # [ "read_hit_2word_clean",  read_hit_2word_clean,  None,                 0,    0.0,  0,  0,  0    ],
  [ "write_hit_1word_clean", write_hit_1word_clean, None,                 0,    0.6,  0,  0,  0    ],
  [ "write_hit_2word_clean", write_hit_2word_clean, None,                 0,    0.7,  0,  0,  0    ],
  [ "read_hit_1word_dirty",  read_hit_1word_dirty,  None,                 0,    0.8,  0,  0,  0    ],
  [ "write_hit_1word_dirty", write_hit_1word_dirty, None,                 0,    0.9,  0,  0,  0    ],
  [ "read_miss_1word",       read_miss_1word_msg,   read_miss_1word_mem,  0,    0.1,  0,  0,  0    ],
  [ "write_miss_1word",      write_miss_1word_msg,  write_miss_1word_mem, 0,    0.2,  0,  0,  0    ],
  [ "read_miss_evict",       read_miss_evict_msg,   read_miss_evict_mem,  0,    0.3,  0,  0,  0    ],
  [ "write_miss_evict",      write_miss_evict_msg,  write_miss_evict_mem, 0,    0.4,  0,  0,  0    ],
  [ "entire_cache_read",     entire_cache_read_msg, entire_cache_read_mem,0,    0.5,  0,  0,  0    ],
  [ "conflict_misses",       conflict_misses_msg,   conflict_misses_mem,  0,    0.6,  0,  0,  0    ],
  [ "capacity_misses",       capacity_misses_msg,   capacity_misses_mem,  0,    0.7,  0,  0,  0    ],
  # [ "LRU",                   LRU_msg,               LRU_mem,              0,    0.8,  0,  0,  0    ],
  [ "read_hit_1word_4bank",  read_hit_1word_clean,  None,                 4,    0.9,  0,  0,  0    ],
