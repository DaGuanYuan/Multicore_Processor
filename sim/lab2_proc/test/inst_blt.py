...
def gen_src0_dep_nottaken_test():
  return [
    gen_br2_src0_dep_test( 5, "blt", 6, 1, False ),
    gen_br2_src0_dep_test( 4, "blt", 6, 2, False ),
    gen_br2_src0_dep_test( 3, "blt", 6, 3, False ),
    gen_br2_src0_dep_test( 2, "blt", 6, 4, False ),
    gen_br2_src0_dep_test( 1, "blt", 6, 5, False ),
...
def gen_src1_dep_nottaken_test():
  return [
    ...
    gen_br2_src1_dep_test( 2, "blt", 6, 4, False ),
    gen_br2_src1_dep_test( 1, "blt", 6, 5, False ),
...
def gen_value_test():
  return [
    ...
    gen_br2_value_test( "blt", 0xffffffff, -2,         False ),
    gen_br2_value_test( "blt", 0xffffffff, -1,         False ),
    gen_br2_value_test( "blt", 0xffffffff, -0,         True  ),
